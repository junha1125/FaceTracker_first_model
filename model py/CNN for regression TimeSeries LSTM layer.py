...
total = img2array('C:/Users/admin/Desktop/train data원본/0823/camera cap data')
train = total[0:16000]
test = total[16000:]
...
total_file = 'C:/Users/admin/Desktop/train data원본/0823/angle_data_suit.csv'
...
a = list()
a.append(df_total.yaw[0:16000])
a.append(df_total.yaw[16000:])
...
x_train_stack_val = x_train_stack[12000:]
x_train_stack = x_train_stack[:12000]


y_train_val = y_train[12000:]
...
with K.tf.device('/gpu:0'):
    ...
    model.add(TimeDistributed(Conv2D(32, kernel_size=(3, 3),
                 padding='same',
                 activation='relu',
                 input_shape=(None, 128, 128,2))))  # output (128,128) 32개
...
model.save('C:/Users/admin/Desktop/My_model.h5')
...
for i in range(plt_row * plt_col):
    ...
    sub_plt.axis('off')
    sub_plt.imshow(x_test[j].reshape(128,128))
